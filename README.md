...
We run the code on a computer with `python 3.8.13`, `cudatoolkit 11.7.0`,`RTX-3090`, `i7 13700KF`, and `128G` memory. Install the dependencies via [Anaconda](https://www.anaconda.com/):
